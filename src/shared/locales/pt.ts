...
const pt: Record<string, string> = {
  ...
  popup_ask_ollama:     'Perguntar ao Ollama',
  ...
  options_ollama_endpoint:         'Endpoint do Ollama',
  options_ollama_use_auth:         'Incluir cabeçalho de autorização',
  options_ollama_hint:              'Ollama Cloud e modelos locais. Compatível com OpenAI.',
  ...
  error_no_ollama_endpoint: 'Nenhum endpoint Ollama configurado. Abra Configurações para adicionar um.',
