...
const pt: Record<string, string> = {
  ...
  popup_pro_mode_on: 'Modo Pro: ativado',
  popup_pro_mode_off: 'Modo Pro: desativado',
  ...
  options_general_pro_mode_help: 'Mostra o editor de prompt e outros controles avan\u00e7ados no popup.',
