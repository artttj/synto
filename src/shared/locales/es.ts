...
const es: Record<string, string> = {
  ...
  popup_ask_ollama:     'Preguntar a Ollama',
  ...
  options_ollama_endpoint:         'Endpoint de Ollama',
  options_ollama_use_auth:         'Incluir encabezado de autorización',
  options_ollama_hint:              'Ollama Cloud y modelos locales. Compatible con OpenAI.',
  ...
  error_no_ollama_endpoint: 'No hay endpoint de Ollama configurado. Abre Ajustes para añadir uno.',
