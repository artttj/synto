...
const zh: Record<string, string> = {
  ...
  popup_pro_mode_on: '专业模式：开',
  popup_pro_mode_off: '专业模式：关',
  popup_prompt_edited: '已编辑',
  ...
  options_general_pro_mode_label: '专业模式',
  options_general_pro_mode_help: '在弹窗中显示提示词编辑器和其他高级控件。',
