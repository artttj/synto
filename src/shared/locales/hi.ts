...
const hi: Record<string, string> = {
  ...
  popup_ask_ollama:     'Ollama से पूछें',
  ...
  options_ollama_endpoint:         'Ollama एंडपॉइंट',
  options_ollama_use_auth:         'Authorization हेडर शामिल करें',
  options_ollama_hint:              'Ollama क्लाउड और स्थानीय मॉडल। OpenAI-संगत।',
  ...
  error_no_ollama_endpoint: 'कोई Ollama एंडपॉइंट कॉन्फ़िगर नहीं। एक जोड़ने के लिए सेटिंग्स खोलें।',
