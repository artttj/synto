...
const it: Record<string, string> = {
  ...
  popup_pro_mode_on: 'Pro mode: attivo',
  popup_pro_mode_off: 'Pro mode: inattivo',
  popup_prompt_edited: 'Modificato',
  ...
  options_general_pro_mode_help: "Mostra l'editor del prompt e altri controlli avanzati nel popup.",
