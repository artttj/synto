...
const en: Record<string, string> = {
  ...
  options_library_view_mine:    'Mine',
  options_library_view_browse:  'Browse',
  options_library_refresh:      'Refresh',
  options_library_cat_all:      'All',
  options_library_add:          'Add',
  options_library_installed:    'Installed',
  options_library_update_available: 'Update available',
  options_library_offline:      'Offline \u2014 showing cached library.',
  options_library_refresh_ok:   'Library updated',
  options_library_refresh_failed: 'Couldn\u2019t reach library',
  ...
  'template_label_understand-thread':  'Thread Summary',
  'template_label_understand-meeting': 'Meeting Notes',
  'template_label_understand-counter': 'Counter-Argument',
  'template_label_decide-decide':      'Decide',
  'template_label_decide-actions':     'Actions',
  'template_label_decide-briefing':    'Strategy',
  'template_label_compose-reply':      'Reply',
  'template_label_compose-diff-summary': 'Diff Summary',
  'template_label_compose-linkedin':   'LinkedIn Post',
  'template_label_compose-x-thread':   'X Thread',
  'template_label_brief-template':     'Project Brief',
  ...
  'template_label_audit-performance':  'Performance',
  'template_label_audit-security':     'Security Review',
  'template_label_audit-schema':       'Schema Markup',
