...
<table>
  <tr>
    <td width="33%" align="center"><img src="docs/synto_2.png" alt="Best pick from Amazon listings" width="100%" /><br/><sub><b>Clip any page to Markdown to paste into any LLM, or chat with it right in the sidebar</b></sub></td>
